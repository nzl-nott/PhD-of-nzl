...
Although the setoid definitions have some nice features in these cases, it requires us to redefine all operations on sets again on setoids, for example $\text{List} (A,\sim)$.
