...
in $A ⇒ B$. \new{The underline characters can also be used as wildcards, if something can be automoatically inferred by Agda.}
...
which will be introduced later. \new{Indeed it encodes the fact that any type in a contractible context is inhabited, and so is the types generated by substituting into a contractible context.}
