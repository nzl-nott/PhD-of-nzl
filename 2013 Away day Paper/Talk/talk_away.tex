...
%\\
%b
%\ar@2{<-} @/^2pc/ "f";"g" _{\alpha}="alpha"
%\ar@2{<-} @/_2pc/ "f";"g" ^{\beta}="beta"
%\ar@3{->} @/^1pc/"alpha";"beta"_{}="A"
%\ar@3{->} @/_1pc/"alpha";"beta"^{}="B"
%\ar@3{~>} "A";"B"
%}
%\end{center}
\begin{center}
...
\\
b
\only<2->{\ar@2{->} @/^2pc/ "p";"p'" _{H}="H"}
\only<3->{\ar@2{->} @/_2pc/ "p";"p'" ^{H'}="H'"}
\only<4->{\ar@3{<-} "H";"H'"_{}="A"}
%\only<4->{\ar@3{<-} @/_1pc/"H";"H'"^{}="B"}
%\only<5>{\ar@3{~>} "A";"B"}
}
\end{center}
...
\item $p := p' := \mbox{refl}_x$
\noalign{\medskip}

\only<3->{\item $H := H' := \mbox{refl}_{\mbox{refl}_x}$}
\noalign{\medskip}

\only<4->{\item $\mbox{refl}_{\mbox{refl}_{\mbox{refl}_x}}$}
\noalign{\medskip}
...
\only<2->{$\rightarrow$ Special case: Hausdorff spaces (or $T_2$)}
\vspace{10pt}

\only<3->{$\rightarrow \rightarrow$ Special case of this special case: Metric spaces}
\vspace{10pt}

\only<4->{$\rightarrow \rightarrow \rightarrow$ Even much more special: Normed vector spaces}
\vspace{10pt}

\only<5->{$\rightarrow \rightarrow \rightarrow \rightarrow$ ...and finally: $\mathbb R ^n$, or just subsets of it!}
