...
%
\\
\>\AgdaKeyword{data} \AgdaDatatype{\_≅'\_} \AgdaSymbol{\{}\AgdaBound{A} \AgdaSymbol{:} \AgdaRecord{Glob}\AgdaSymbol{\}} \AgdaSymbol{:} \AgdaSymbol{\{}\AgdaBound{B} \AgdaSymbol{:} \AgdaRecord{Glob}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaField{∣} \AgdaBound{A} \AgdaField{∣} \AgdaSymbol{→} \<[45]%
\>[45]\AgdaField{∣} \AgdaBound{B} \AgdaField{∣} \AgdaSymbol{→} \AgdaPrimitiveType{Set} \AgdaKeyword{where}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaInductiveConstructor{refl} \AgdaSymbol{:} \AgdaSymbol{(}\AgdaBound{a} \AgdaSymbol{:} \AgdaField{∣} \AgdaBound{A} \AgdaField{∣}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaDatatype{\_≅'\_} \AgdaSymbol{\{}\AgdaBound{A}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{A}\AgdaSymbol{\}} \AgdaBound{a} \AgdaBound{a}\<%
\\
%
\\
%
\\
\>\AgdaFunction{EqGlob} \AgdaSymbol{:} \AgdaSymbol{(}\AgdaBound{A} \AgdaBound{B} \AgdaSymbol{:} \AgdaRecord{Glob}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaSymbol{(}\AgdaBound{A} \AgdaDatatype{≡} \AgdaBound{B}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaRecord{Σ} \AgdaSymbol{(}\AgdaField{∣} \AgdaBound{A} \AgdaField{∣} \AgdaDatatype{≡} \AgdaField{∣} \AgdaBound{B} \AgdaField{∣}\AgdaSymbol{)} \AgdaSymbol{(λ} \AgdaBound{p} \AgdaSymbol{→} \AgdaFunction{subst} \AgdaSymbol{(λ} \AgdaBound{x} \AgdaSymbol{→} \AgdaBound{x} \AgdaSymbol{→} \AgdaBound{x} \AgdaSymbol{→} \AgdaDatatype{∞} \AgdaRecord{Glob}\AgdaSymbol{)} \AgdaBound{p} \AgdaSymbol{(}\AgdaField{hom} \AgdaBound{A}\AgdaSymbol{)} \AgdaDatatype{≡} \AgdaField{hom} \AgdaBound{B}\AgdaSymbol{)}\<%
\\
...
%
\\
\>\AgdaFunction{EqHom} \AgdaSymbol{:} \AgdaSymbol{\{}\AgdaBound{A} \AgdaBound{B} \AgdaSymbol{:} \AgdaRecord{Glob}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaSymbol{(}\AgdaBound{p} \AgdaSymbol{:} \AgdaBound{A} \AgdaDatatype{≡} \AgdaBound{B}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaSymbol{\{}\AgdaBound{x} \AgdaBound{y} \AgdaSymbol{:} \AgdaField{∣} \AgdaBound{A} \AgdaField{∣}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaSymbol{\{}\AgdaBound{m} \AgdaBound{n} \AgdaSymbol{:} \AgdaField{∣} \AgdaBound{B} \AgdaField{∣}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaSymbol{(}\AgdaFunction{subst} \AgdaField{∣\_∣} \AgdaBound{p} \AgdaBound{x} \AgdaDatatype{≡} \AgdaBound{m}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaSymbol{(}\AgdaFunction{subst} \AgdaField{∣\_∣} \AgdaBound{p} \AgdaBound{y} \AgdaDatatype{≡} \AgdaBound{n}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaFunction{♭} \AgdaSymbol{(}\AgdaField{hom} \AgdaBound{A} \AgdaBound{x} \AgdaBound{y}\AgdaSymbol{)} \AgdaDatatype{≡} \AgdaFunction{♭} \AgdaSymbol{(}\AgdaField{hom} \AgdaBound{B} \AgdaBound{m} \AgdaBound{n}\AgdaSymbol{)}\<%
\\
...
%
\\
\>\AgdaFunction{subst-p1} \AgdaSymbol{:} \AgdaSymbol{\{}\AgdaBound{A} \AgdaBound{B} \AgdaSymbol{:} \AgdaRecord{Glob}\AgdaSymbol{\}(}\AgdaBound{x} \AgdaSymbol{:} \AgdaField{∣} \AgdaBound{A} \AgdaField{∣}\AgdaSymbol{)(}\AgdaBound{p} \AgdaBound{q} \AgdaSymbol{:} \AgdaBound{A} \AgdaDatatype{≡} \AgdaBound{B}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaFunction{subst} \AgdaField{∣\_∣} \AgdaBound{p} \AgdaBound{x} \AgdaDatatype{≡} \AgdaFunction{subst} \AgdaField{∣\_∣} \AgdaBound{q} \AgdaBound{x}\<%
\\
...
%
\\
\>\AgdaFunction{subst-p2} \AgdaSymbol{:} \AgdaSymbol{\{}\AgdaBound{A} \AgdaBound{B} \AgdaBound{C} \AgdaSymbol{:} \AgdaRecord{Glob}\AgdaSymbol{\}(}\AgdaBound{x} \AgdaSymbol{:} \AgdaField{∣} \AgdaBound{A} \AgdaField{∣}\AgdaSymbol{)(}\AgdaBound{p} \AgdaSymbol{:} \AgdaBound{B} \AgdaDatatype{≡} \AgdaBound{C}\AgdaSymbol{)(}\AgdaBound{q} \AgdaSymbol{:} \AgdaBound{A} \AgdaDatatype{≡} \AgdaBound{B}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaFunction{subst} \AgdaField{∣\_∣} \AgdaBound{p} \AgdaSymbol{(}\AgdaFunction{subst} \AgdaField{∣\_∣} \AgdaBound{q} \AgdaBound{x}\AgdaSymbol{)} \AgdaDatatype{≡} \AgdaFunction{subst} \AgdaField{∣\_∣} \AgdaSymbol{(}\AgdaFunction{trans} \AgdaBound{q} \AgdaBound{p}\AgdaSymbol{)} \AgdaBound{x}\<%
\\
...
\\
\>[0]\AgdaIndent{9}{}\<[9]%
\>[9]\AgdaSymbol{:} \AgdaSymbol{(}\AgdaBound{B} \AgdaSymbol{:} \AgdaRecord{Glob}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaField{∣} \AgdaBound{A} \AgdaField{∣} \AgdaSymbol{→} \AgdaField{∣} \AgdaBound{B} \AgdaField{∣} \AgdaSymbol{→} \AgdaPrimitiveType{Set} \AgdaKeyword{where}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaInductiveConstructor{refl} \AgdaSymbol{:} \AgdaSymbol{(}\AgdaBound{b} \AgdaSymbol{:} \AgdaField{∣} \AgdaBound{A} \AgdaField{∣}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaDatatype{[} \AgdaBound{A} \AgdaDatatype{]} \AgdaBound{b} \AgdaDatatype{≅s} \AgdaBound{b}\<%
\\
%
\\
...
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaField{∣\_∣f} \<[11]%
\>[11]\AgdaSymbol{:} \AgdaField{∣} \AgdaBound{A} \AgdaField{∣} \AgdaSymbol{→} \AgdaPrimitiveType{Set}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaField{homf} \AgdaSymbol{:} \AgdaSymbol{(}\AgdaBound{a} \AgdaBound{a'} \AgdaSymbol{:} \AgdaField{∣} \AgdaBound{A} \AgdaField{∣}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaBound{∣\_∣f} \AgdaBound{a} \AgdaSymbol{→} \AgdaBound{∣\_∣f} \AgdaBound{a'} \AgdaSymbol{→} \AgdaFunction{♭} \AgdaSymbol{(}\AgdaField{hom} \AgdaBound{A} \AgdaBound{a} \AgdaBound{a'}\AgdaSymbol{)} \AgdaRecord{⇒Glob}\<%
\\
